		...
		<section>
			<form class="send_button" id="frm" name="frm" method="post">
				...
				<div class="write_content">
					...
					<textarea class="content" rows="12" cols="80" id="bbsCn"
						name="bbsCn"></textarea>
				</div>
				<div class="write_buttons">
					<input class="default_button" type="submit" id="submit" name="submit"
						value="등록하기" /> <input class="default_button write_buttons_gray"
						type="button" value="목록으로" onclick="location.href='/'" />
				</div>
			</form>
		</section>
	</div>
